...
| upstream_keepalive_pool_shards | Internal shard count for the upstream keepalive pool (reduces lock contention; total cap remains `upstream_keepalive_pool_size`). Default: 1 | number |
